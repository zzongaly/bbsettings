/*---------------------------------------------------------------------------
 * This is mklib version 2.0.0B2 for PRU compiler  
...
/*--------------------------------------------------------------------------- 
 * This source code is specific to compiler RTS library version 2.0.0B2.  
...
library_t LIBRARIES[] = {
    ...
    { "rtspruv2_le_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","V2","LITTLE_ENDIAN" } },
