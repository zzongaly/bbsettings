...
This is the first beta release of the PRU C/C++ code generation tools (CGT).
...
--hardware_mac=on,off:
        By default the hardware multiplier is not enabled. If your PRU core
        supports the multiply-accumulate coprocessor then you should enable
        this option. With this option enabled the compiler will automatically
        use the multiply feature and will convert loops with multiply accumulate
        sequences to use the coprocessor.
